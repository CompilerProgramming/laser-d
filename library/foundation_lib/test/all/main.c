...
main_initialize(void) {
	...
	// APPLICATION_UNATTENDED suppresses assert/alert dialogs so headless CI
	// runners do not block on the system message box.
	application.flags = APPLICATION_UTILITY | APPLICATION_UNATTENDED;

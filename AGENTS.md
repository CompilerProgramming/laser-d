...
- Goal 1 - Compiler will always run win -betterC mode, this cannot be changed. Thus the language will not have GC or a runtime
           other than the C runtime.
- Goal 2 - Portable - language will remain portable to Windows, Linux and MacOSX, initailly x86-64. ARM64 support will be added
           when upstream has it.
...
- Testing expectations - Since this will be a subset of D, existing test suite is likely to fail. We will need to create
  new set of tests for the language.

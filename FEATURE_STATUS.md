...
| Advanced struct behavior | Undecided | Bit fields, advanced copy/move constructors, and operator-specific behavior will be decided with their dependent function, expression, or operator categories. | None |

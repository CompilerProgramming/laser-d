...
| Explicit allocation library | Supported | `laserd.rpmalloc` exposes the reviewed rpmalloc general-allocation and caller-owned first-class heap APIs through implementation-neutral names. Allocation, ownership, heap thread confinement, and release remain explicit; the module does not introduce language allocation or garbage collection. | `DESIGN.md`, `library/README.md` | None | `library/test/rpmalloc.d` |

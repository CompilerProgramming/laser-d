...
Laser-D does not expose arbitrary druntime or Phobos modules. Its
compiler-distributed standard library contains a reviewed `core.stdc`
subset whose declarations compile as Laser-D and resolve against the platform
C runtime. An import outside the distributed library is not made supported
merely because an upstream D installation provides a module with that name.
